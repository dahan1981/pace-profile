...
const PhotoPlaceholder = ({ label }: { label: string }) => (
  <div className="relative overflow-hidden rounded-[2rem] border border-white/70 bg-[linear-gradient(180deg,_rgba(255,255,255,0.95)_0%,_rgba(238,242,247,0.92)_100%)] shadow-xl shadow-slate-200/45">
...
const AboutAdemir = () => {
  return (
    <div className="min-h-screen overflow-x-hidden bg-[linear-gradient(180deg,_#f6f3ee_0%,_#f2f5f9_44%,_#f8fafc_100%)] text-slate-950">
      ...
      <section className="px-4 pb-16 pt-20 md:pb-24 md:pt-24">
      ...
      {ademirSections.map((section, index) => {
        ...
        return (
          <section key={section.title} className="px-4 py-14 md:py-20">
            <div
          ...
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="grid gap-3">
              {ademirMilestones.map((item, index) => (
                <div key={item} className="rounded-[1.4rem] border border-white/10 bg-white/6 px-5 py-4">
        ...
        <div className="container mx-auto">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {ademirLegacy.map((item) => (
              <div key={item.title} className="rounded-[2rem] border border-white/80 bg-white/84 p-8 shadow-xl shadow-slate-200/45">
