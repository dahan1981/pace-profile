...
import { ArrowLeft, Building2, CheckCircle2, User } from 'lucide-react';
...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent, type: 'usuario' | 'empresa') => {
    ...
    try {
      ...
      window.alert(error instanceof Error ? error.message : 'Nao foi possivel entrar.');
    }
  };
        ...
        <div className="hidden lg:block">
          <div className="max-w-xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">
              Uma experiencia leve, elegante e direta ao ponto. Sem excesso de elementos, sem aparencia de template, so o que ajuda voce a entrar e seguir.
            </p>
          </div>
        </div>
            ...
            <CardContent className="p-7 md:p-8">
              ...
              {emailConfirmed ? (
                <div className="mb-6 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-4 text-sm text-emerald-900">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-semibold">E-mail confirmado com sucesso.</div>
                      <div className="mt-1 leading-6">
                        Sua conta ja foi ativada. Agora voce pode entrar normalmente.
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="mb-6">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Se a sua conta tiver permissao administrativa, o acesso sera direcionado automaticamente ao painel admin.
                </p>
              </div>
              ...
              <Tabs value={tab} onValueChange={setTab}>
                ...
                <TabsContent value="usuario">
                  <form onSubmit={(e) => handleLogin(e, 'usuario')} className="space-y-4">
                    ...
                    <p className="text-center text-sm text-muted-foreground">
                      Ainda nao tem conta? <Link to="/cadastro" className="font-medium text-primary hover:underline">Criar acesso</Link>
                    </p>
                  </form>
                </TabsContent>
                ...
                <TabsContent value="empresa">
                  <form onSubmit={(e) => handleLogin(e, 'empresa')} className="space-y-4">
                    ...
                    <p className="text-center text-sm text-muted-foreground">
                      Ainda nao tem acesso? <Link to="/cadastro?type=empresa" className="font-medium text-primary hover:underline">Cadastrar empresa</Link>
                    </p>
                  </form>
                </TabsContent>
              </Tabs>
